...
export type StorageHash =
  StorageHashBase<'0a290316529d86579865bf5b51988c540098ed83fead7cbe86cf7da4a8c6ef95'>;
...
export type FieldOutputTypes = {
  readonly public: {
    readonly Cliente: {
      ...
      readonly nomeCliente: CodecTypes['sql/varchar@1']['output'] | null;
      readonly emailCliente: CodecTypes['sql/varchar@1']['output'] | null;
    };
    readonly TelCliente: {
      readonly idTelCliente: CodecTypes['pg/int4@1']['output'];
      readonly idCliente: CodecTypes['pg/int4@1']['output'] | null;
    };
    readonly Teste: {
      readonly idTeste: CodecTypes['pg/int4@1']['output'];
      readonly nomeTeste: CodecTypes['sql/varchar@1']['output'] | null;
    };
    readonly User: {
...
export type FieldInputTypes = {
  readonly public: {
    readonly Cliente: {
      ...
      readonly nomeCliente: CodecTypes['sql/varchar@1']['input'] | null;
      readonly emailCliente: CodecTypes['sql/varchar@1']['input'] | null;
    };
    readonly TelCliente: {
      readonly idTelCliente: CodecTypes['pg/int4@1']['input'];
      readonly idCliente: CodecTypes['pg/int4@1']['input'] | null;
    };
    readonly Teste: {
      readonly idTeste: CodecTypes['pg/int4@1']['input'];
      readonly nomeTeste: CodecTypes['sql/varchar@1']['input'] | null;
    };
    readonly User: {
...
export type StorageColumnTypes = {
  readonly public: {
    readonly cliente: {
      readonly email_cliente: CodecTypes['sql/varchar@1']['output'] | null;
      readonly id_cliente: CodecTypes['pg/int4@1']['output'];
      readonly nome_cliente: CodecTypes['sql/varchar@1']['output'] | null;
    };
    readonly tel_cliente: {
      readonly id_cliente: CodecTypes['pg/int4@1']['output'] | null;
      readonly id_tel_cliente: CodecTypes['pg/int4@1']['output'];
    };
    readonly teste: {
      readonly id_Teste: CodecTypes['pg/int4@1']['output'];
      readonly nome_test: CodecTypes['sql/varchar@1']['output'] | null;
    };
    readonly user: {
      readonly createdAt: CodecTypes['pg/timestamptz-temporal@1']['output'];
      readonly email: CodecTypes['pg/text@1']['output'];
...
export type StorageColumnInputTypes = {
  readonly public: {
    readonly cliente: {
      readonly email_cliente: CodecTypes['sql/varchar@1']['input'] | null;
      readonly id_cliente: CodecTypes['pg/int4@1']['input'];
      readonly nome_cliente: CodecTypes['sql/varchar@1']['input'] | null;
    };
    readonly tel_cliente: {
      readonly id_cliente: CodecTypes['pg/int4@1']['input'] | null;
      readonly id_tel_cliente: CodecTypes['pg/int4@1']['input'];
    };
    readonly teste: {
      readonly id_Teste: CodecTypes['pg/int4@1']['input'];
      readonly nome_test: CodecTypes['sql/varchar@1']['input'] | null;
    };
    readonly user: {
      readonly createdAt: CodecTypes['pg/timestamptz-temporal@1']['input'];
      readonly email: CodecTypes['pg/text@1']['input'];
...
export namespace Models {
  ...
  export type public_Teste = {
    idTeste: CodecTypes['pg/int4@1']['output'];
    nomeTeste: CodecTypes['sql/varchar@1']['output'] | null;
    readonly [RelationKeys]?: never;
  };
}
...
export declare const models: {
  public: {
    ...
    TelCliente: Models.public_TelCliente;
    User: Models.public_User;
    Teste: Models.public_Teste;
  };
};
          ...
          readonly table: {
            readonly cliente: {
              columns: {
                ...
                readonly nome_cliente: {
                  readonly nativeType: 'character varying';
                  readonly codecId: 'sql/varchar@1';
                  readonly nullable: true;
                };
                readonly email_cliente: {
                  readonly nativeType: 'character varying';
                  readonly codecId: 'sql/varchar@1';
                  readonly nullable: true;
                };
            ...
            readonly tel_cliente: {
              ...
              primaryKey: {
                readonly columns: readonly ['id_tel_cliente'];
                readonly name: 'tel_cliente_pkey';
              };
              uniques: readonly [];
              indexes: readonly [];
              foreignKeys: readonly [
                {
                  readonly source: {
                    ...
                    readonly tableName: 'tel_cliente';
                    readonly columns: readonly ['id_cliente'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
            ...
            readonly teste: {
              ...
              primaryKey: {
                readonly columns: readonly ['id_Teste'];
                readonly name: 'idTeste_pkey';
              };
              uniques: readonly [];
              indexes: readonly [];
              foreignKeys: readonly [];
...
> & {
  ...
  readonly roots: {
    ...
    readonly teste: { readonly namespace: 'public' & NamespaceId; readonly model: 'Teste' };
  };
  readonly domain: {
    readonly namespaces: {
      readonly public: {
        readonly models: {
          readonly Cliente: {
            readonly fields: {
              ...
              readonly emailCliente: {
                readonly nullable: true;
                readonly type: { readonly kind: 'scalar'; readonly codecId: 'sql/varchar@1' };
              };
            };
            readonly relations: {
              readonly telClientes: {
                readonly to: {
                  readonly namespace: 'public' & NamespaceId;
                  readonly model: 'TelCliente';
                };
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly nomeCliente: { readonly column: 'nome_cliente' };
                readonly emailCliente: { readonly column: 'email_cliente' };
              };
            };
          };
          readonly TelCliente: {
            readonly fields: {
              readonly idTelCliente: {
                readonly nullable: false;
                readonly type: { readonly kind: 'scalar'; readonly codecId: 'pg/int4@1' };
              };
              readonly idCliente: {
            ...
            readonly storage: {
              readonly table: 'tel_cliente';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly idTelCliente: { readonly column: 'id_tel_cliente' };
                readonly idCliente: { readonly column: 'id_cliente' };
              };
            };
          };
          readonly Teste: {
            ...
            readonly storage: {
              readonly table: 'teste';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly idTeste: { readonly column: 'id_Teste' };
                readonly nomeTeste: { readonly column: 'nome_test' };
              };
            };
          };
          readonly User: {
